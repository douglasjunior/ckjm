...
public class ClassVisitor extends org.apache.bcel.classfile.EmptyVisitor {
	...
	public void visitJavaClass(JavaClass jc) {
		...
		if (jc.isPublic())
			cm.setPublic();
		ClassMetrics pm = cmap.getMetrics(visitedClass);
	...
	public void registerCoupling(String className) {
		...
		if ((MetricsFilter.isJdkIncluded() || !ClassMetrics
				.isJdkClass(className)) && !myClassName.equals(className)) {
			efferentCoupledClasses.add(className);
			cmap.getMetrics(visitedClass).addAfferentCoupling(myClassName);
		}
	}
